...
INSERT INTO `vente` (`codart`, `numfou`, `delliv`, `qte1`, `prix1`, `qte2`, `prix2`, `qte3`, `prix3`) VALUES
	...
	CREATE USER 'utilisateur1'@'%' IDENTIFIED BY 'Afpa1234';
	GRANT ALL PRIVILEGES ON papyrus.* TO 'utilisateur1'@'%';
	
	CREATE USER 'utilisateur2'@'%' IDENTIFIED BY 'Afpa1234';
	GRANT SELECT ON  papyrus.* TO 'utilisateur2'@'%' ;
	
	CREATE USER 'utilisateur3'@'%' IDENTIFIED BY 'Afpa1234';
	GRANT SELECT ON  papyrus.fournis TO 'utilisateur3'@'%'; 
